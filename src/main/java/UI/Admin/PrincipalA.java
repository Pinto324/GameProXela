...
public class PrincipalA extends javax.swing.JFrame {
     ...
     * @param datos
     */
    public PrincipalA(javax.swing.JFrame padre,String[] da) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanelFondo.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 160, 434));
        ...
        jLabel4.setText("Manejo de tarjetas");
    ...
    private void jPanelVentasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelVentasMouseClicked
        ...
        IngresarUsuario md = new IngresarUsuario(this, true, datos);
        md.setVisible(true);
    ...
    public void funcionIngreso(){
        this.setVisible(false);
        Reportes ingreso = new Reportes(this,true,datos);
