...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BtnEntrar.setForeground(new java.awt.Color(25, 118, 211));
        ...
        jPanel2.add(BtnEntrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(34, 306, 341, 40));
    ...
    private void BtnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEntrarActionPerformed
        if(!(txtusername.getText().equals("")) && !(txtpassword.getText().equals(""))){
            ...
            try {
                String[] info = login.ComprobarUsuario(txtusername.getText(), txtpassword.getText());
                if(info[0].equals("-1")){
